...
import percenterList from './components/Administrative/personnel/percenter/list.vue'
import percenterAdd from './components/Administrative/personnel/percenter/add.vue'
import percenterEdit from './components/Administrative/personnel/percenter/edit.vue'
import personal from './components/Administrative/personnel/personal/list.vue'
/**
 * meta参数解析
...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path: 'percenter/list', component: percenterList, name: 'percenterList', meta: { hideLeft: false, module: 'Administrative', menu: 'percenter' }},
      { path: 'percenter/add', component: percenterAdd, name: 'percenterAdd', meta: { hideLeft: false, module: 'Administrative', menu: 'percenter' }},
      { path: 'percenter/edit/:id', component: percenterEdit, name: 'percenterEdit', meta: { hideLeft: false, module: 'Administrative', menu: 'percenter' }}
    ]
  },
  {
    path: '/home',
    component: Home,
    children: [
      { path: 'personal/list', component: personal, name: 'personal', meta: { hideLeft: false, module: 'Administrative', menu: 'personal' }}
    ]
  }
