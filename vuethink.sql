...
INSERT INTO `oa_admin_menu` VALUES ('63', '61', '个人中心', '/home/percenter/list', '', '1', '0', '1', '55', 'Administrative', 'percenter');
INSERT INTO `oa_admin_menu` VALUES ('64', '61', '个人简介', '/home/personal/list', '', '1', '0', '1', '62', 'Administrative', 'personal');

-- ----------------------------
-- Table structure for oa_admin_personal
-- ----------------------------
DROP TABLE IF EXISTS `oa_admin_personal`;
CREATE TABLE `oa_admin_personal` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(100) DEFAULT NULL COMMENT '管理后台账号',
  `iphone` varchar(100) DEFAULT NULL COMMENT '管理后台密码',
  `address` varchar(100) DEFAULT NULL COMMENT '用户备注',
  `sex` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='个人简介表';

-- ----------------------------
-- Records of oa_admin_personal
-- ----------------------------
INSERT INTO `oa_admin_personal` VALUES ('1', '小红', '123213123', '中国', '男');
...
-- ----------------------------
-- Table structure for oa_admin_userss
-- ----------------------------
DROP TABLE IF EXISTS `oa_admin_userss`;
CREATE TABLE `oa_admin_userss` (
...
-- ----------------------------
-- Records of oa_admin_userss
-- ----------------------------
INSERT INTO `oa_admin_userss` VALUES ('dfdsafsa', 'fadfadsfdsa', '324324141', 'rret', '1', '1');
INSERT INTO `oa_admin_userss` VALUES ('ooknoom', 'njkhjkhjkn', '12454643', '5gfdh5', '2', '1');
INSERT INTO `oa_admin_userss` VALUES ('rhgrgre', 'grgrg', '0', 'gregre', '3', '1');
INSERT INTO `oa_admin_userss` VALUES ('thtfht', 'hthth', '31114151', 'ththt', '4', '1');
INSERT INTO `oa_admin_userss` VALUES ('fefefe', 'ggrasgas', '2147483647', 'sdgrg', '5', '1');
